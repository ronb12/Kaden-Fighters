#!/usr/bin/env python3
"""
Replace ASTRA cell (0,0) in assets/astra_yuki.png with assets/yuki-gameplay.png
...
SHEET = os.path.join(ROOT, "assets", "astra_yuki.png")
HD = os.path.join(ROOT, "assets", "yuki-gameplay.png")
